            ...
            "info" => {
                conn.write_string(
                    concat_string!(
                        ...
                        "\r\n",
                        "# Memory\r\n",
                        "used_memory:481562320\r\n",
                        "used_memory_human:459.25M\r\n",
                        "used_memory_rss:498274304\r\n",
                        "used_memory_rss_human:475.19M\r\n",
                        "used_memory_peak:481599208\r\n",
                        "used_memory_peak_human:459.29M\r\n",
                        "used_memory_peak_perc:99.99%\r\n",
                        "used_memory_overhead:138076080\r\n",
                        "used_memory_startup:867280\r\n",
                        "used_memory_dataset:343486240\r\n",
                        "used_memory_dataset_perc:71.46%\r\n",
                        "allocator_allocated:481668536\r\n",
                        "allocator_active:481939456\r\n",
                        "allocator_resident:493563904\r\n",
                        ...
                        "rdb_changes_since_last_save:7086511\r\n",
                        ...
                        "\r\n",
                        "# Stats\r\n",
                        "total_connections_received:131\r\n",
                        "total_commands_processed:9485903\r\n",
                        "instantaneous_ops_per_sec:0\r\n",
                        "total_net_input_bytes:767216910\r\n",
                        "total_net_output_bytes:341912010\r\n",
                        ...
                        "total_reads_processed:9493417\r\n",
                        "total_writes_processed:9493462\r\n",
                        "io_threaded_reads_processed:0\r\n",
                        "io_threaded_writes_processed:0\r\n",
                        "reply_buffer_shrinks:33339\r\n",
                        "reply_buffer_expands:33497\r\n",
                        "eventloop_cycles:115511139\r\n",
                        "eventloop_duration_sum:73330375542\r\n",
                        "eventloop_duration_cmd_sum:56929660351\r\n",
                        "instantaneous_eventloop_cycles_per_sec:9\r\n",
                        "instantaneous_eventloop_duration_usec:152\r\n",
                        "acl_access_denied_auth:0\r\n",
                        "acl_access_denied_cmd:7222\r\n",
                        ...
                        "\r\n",
                        "# CPU\r\n",
                        "used_cpu_sys:7851.875160\r\n",
                        "used_cpu_user:69537.053277\r\n",
                        "used_cpu_sys_children:0.006738\r\n",
                        "used_cpu_user_children:0.001050\r\n",
                        "used_cpu_sys_main_thread:7849.869187\r\n",
                        "used_cpu_user_main_thread:69533.413047\r\n",
                        "\r\n",
                        "# Modules\r\n",
                        "\r\n",
                        "# Errorstats\r\n",
                        "errorstat_BUSYGROUP:count=6\r\n",
                        "errorstat_ERR:count=10640\r\n",
                        "errorstat_EXECABORT:count=6\r\n",
                        "errorstat_NOAUTH:count=1\r\n",
                        "errorstat_NOPERM:count=7216\r\n",
                        "errorstat_WRONGTYPE:count=1312\r\n",
                        "\r\n",
                        "# Cluster\r\n",
                        "cluster_enabled:0\r\n",
                        "\r\n",
                        "# Keyspace\r\n",
                        "db0:keys=2584890,expires=7883,avg_ttl=5288936749671997\r\n"
                    )
                    .as_str(),
                );
            }
